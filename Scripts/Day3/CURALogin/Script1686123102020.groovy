...
CustomKeywords.'abc.CURALoginKey.CURALogin'('John', 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Medicare (1)'))
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_7 (1)'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Book My Appointment')
