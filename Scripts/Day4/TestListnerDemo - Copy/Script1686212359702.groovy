...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Full Name_name'), 'Komal Patel')
...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Address_address'), 'Ahemdabad Bopal')

WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Email_email'), 'komal.patel@gmail.com')
