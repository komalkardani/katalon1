...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Full Name_name'), 'Komal Kardani')
...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Address_address'), 'Ahemdabad')

WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Email_email'), 'komal@gmail.com')
